        ...
        <nav className="flex justify-center items-center gap-5 text-xs lg:text-sm">
          ...
          >
            ...
            >
              {/* <Link
                href="/category"
                className={`${currentQuery("/category")} hover:text-blue-400 ${open && "text-pink-400"
                  }`} 
              >
                Category
              </Link> */}
              ...
              {open && categories && (
                ...
                //     className="inline-flex justify-between hover:bg-emerald-200 hover:text-gray-700"
                //   >
                //     <Link
                //       href={`/category/${category.strCategory}`}
                //       key={category.idCategory}
                ...
                //     </Link>
                //     <StarToggle<CategoryType>
                //       item={category}
                //       favorites={favCategories}
                //       onUpdateFavorites={setFavCategories}
                //       updateFavoritesInContext={setFavCategories}
                //     />
                //   </div>
                // );
                // })
...
// [text-shadow:_0_2px_4px_rgb(8_145_178_/_0.8)]
